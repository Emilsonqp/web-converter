...
class VistaFile(Resource):
    ...
    def get(self, filename):
        ...
        try:
            ...
            client.download_file(recordings_bucket,f'app/files/{tasks[0].filename}', f'app/files/{tasks[0].filename}')
            return send_from_directory("/home/ubuntu/Proyecto-Grupo11-202120/converter/app/files/", tasks[0].filename, as_attachment=True)
        except Exception as e:
